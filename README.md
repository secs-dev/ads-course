...
Обратите внимание на [нормы поведения](./CODE_OF_CONDUCT.md). При сдаче первой задачи в контест автоматически
считается, что вы ознакомлены и принимаете данные нормы.
